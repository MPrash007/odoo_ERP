    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2 md:col-span-2">
          <Label htmlFor="name">Vendor Name <span className="text-[#E53935]">*</span></Label>
          <Input id="name" {...form.register("name")} placeholder="e.g. Timber Supplies Inc." />
        ...
        <div className="space-y-2">
          ...
          <Input id="email" type="email" {...form.register("email")} placeholder="sales@vendor.com" />
        ...
        <div className="space-y-2 md:col-span-2">
          ...
          <Textarea 
            ...
            placeholder="Full vendor address details..."
